...
map.getView().fit([12532869.417348, -804044.207008, 12540838.811833, -799011.562624], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Rencana Struktur Ruang</h2>';
        return titleElement;
    })(),
